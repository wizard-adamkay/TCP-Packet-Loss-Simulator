...
class GUI:
    ...
    fig2 = plt.Figure(figsize=(15, 4), dpi=100)
    seqNumGraphyMax = 50
    winSizeGraphyMax = 16
    delay = 0
    packetLoss = 0
    ...
    def update_graph1(self, lineNum, y):
        ...
        self.a.set_xlim([0, max(30, int(t1 - self.baseTime + 2))])
    ...
    def update_graph2(self, lineNum, y):
        ...
        self.b.set_xlim([0, max(30, int(t1 - self.baseTime + 2))])
        self.b.set_ylim([0, self.winSizeGraphyMax])
        self.fig2.canvas.draw()

    def update_dropped_packets(self, droppedPackets):
        self.droppedPackets.set("Packets Dropped by Relay: " + str(droppedPackets))
    ...
    def run(self):
        ...
        Label(graphs, text="Sequence Number Over Time (red = transmitter, blue = receiver)").pack()
        chart.get_tk_widget().pack()
        Label(graphs, text="Windowsize Over Time").pack()
        ...
        delaySlider = Scale(controls, orient=HORIZONTAL, from_=0, to=6000, length=300, command=update_delay_slider,
                            showvalue=0)
        ...
        errorLabel.pack()
        errorSlider.pack()
        self.droppedPackets = StringVar()
        self.droppedPackets.set("Packets Dropped by Relay: 0")
        droppedPacketsLabel = Label(controls, textvariable = self.droppedPackets)
        droppedPacketsLabel.pack()
        top.mainloop()
